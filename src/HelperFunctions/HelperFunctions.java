...
public static String generateShippingTrackingNumber(String fullname, String city, String zipcode){
    String e=city.toUpperCase().substring(0,3)+zipcode.toUpperCase()+fullname.toUpperCase().substring(0,1)+
            fullname.toUpperCase().substring(fullname.indexOf(" ")+1,fullname.indexOf(" ")+2);
...
public static String checkZipCode(String zipCode){
    String a="";
        ...
        if (zipCode.length()==5){
            a=zipCode;
        }else throw new RuntimeException("Please enter valid Zip Code");
